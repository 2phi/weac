...
class TestSystemModelBehavior(unittest.TestCase):
    ...
    @patch("weac_2.core.system_model.SlabTouchdown")
    ...
    @patch(
        "weac_2.core.system_model.UnknownConstantsSolver.solve_for_unknown_constants"
    )
    @patch("weac_2.core.system_model.SlabTouchdown")
    ...
    def test_toggle_touchdown_switches_solver_arguments(self, mock_solve):
        ...
        with patch("weac_2.core.system_model.SlabTouchdown") as mock_td:
            mock_inst = MagicMock()

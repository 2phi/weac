...
class TestFieldQuantitiesBasic(unittest.TestCase):
    ...
    def test_center_line_displacement(self):
        ...
        expected = self.Z[2, :]
        np.testing.assert_array_equal(w_values, expected,
    ...
    def test_center_line_displacement_units(self):
        ...
        np.testing.assert_array_almost_equal(w_m * 1000, w_mm, decimal=10,
                                           err_msg="Meter to mm conversion should be correct")
        np.testing.assert_array_almost_equal(w_cm * 10, w_mm, decimal=10,
    ...
    def test_center_line_displacement_derivative(self):
        ...
        expected = self.Z[3, :]
        np.testing.assert_array_equal(dw_dx, expected,
                                     err_msg="Displacement derivative should equal w' component")
    ...
    def test_rotation_calculation(self):
        ...
        np.testing.assert_array_equal(psi_rad, expected_rad,
                                     err_msg="Rotation in radians should equal psi component")
        
        # Degrees should be converted
        expected_deg = expected_rad * 180 / np.pi
        np.testing.assert_array_almost_equal(psi_deg, expected_deg, decimal=10,
    ...
    def test_rotation_derivative(self):
        ...
        expected = self.Z[5, :]
        np.testing.assert_array_equal(dpsi_dx, expected,
                                     err_msg="Rotation derivative should equal psi' component")
...
class TestFieldQuantitiesDisplacements(unittest.TestCase):
    ...
    def test_displacement_at_different_heights(self):
        ...
        np.testing.assert_array_almost_equal(u_values, expected, decimal=10,
    ...
    def test_displacement_derivative_at_height(self):
        ...
        np.testing.assert_array_almost_equal(du_dx, expected, decimal=10,
    ...
    def test_displacement_at_centerline(self):
        ...
        expected = self.Z[0, :]
        np.testing.assert_array_equal(u_centerline, expected,
                                     err_msg="Displacement at centerline should equal u0")
...
class TestFieldQuantitiesStresses(unittest.TestCase):
    ...
    def test_axial_force_calculation(self):
        ...
        # N = A11 * u' + B11 * psi'
        expected = (self.fq.es.A11 * self.Z[1, :] + 
                   self.fq.es.B11 * self.Z[5, :])
    ...
    def test_bending_moment_calculation(self):
        ...
        # M = B11 * u' + D11 * psi'
        expected = (self.fq.es.B11 * self.Z[1, :] + 
                   self.fq.es.D11 * self.Z[5, :])
    ...
    def test_shear_force_calculation(self):
        ...
        np.testing.assert_array_almost_equal(V, expected, decimal=10,
    ...
    def test_weak_layer_normal_stress(self):
        ...
        np.testing.assert_array_almost_equal(sig_MPa, expected_MPa, decimal=10,
                                           err_msg="Normal stress should follow sig = -kn*w")
        
        # Check unit conversion
        np.testing.assert_array_almost_equal(sig_kPa, sig_MPa * 1000, decimal=8,
                                           err_msg="kPa should be 1000 times MPa")
    ...
    def test_weak_layer_shear_stress(self):
        ...
        np.testing.assert_array_almost_equal(tau, expected, decimal=10,
...
class TestFieldQuantitiesStrains(unittest.TestCase):
    ...
    def test_normal_strain_calculation(self):
        ...
        np.testing.assert_array_almost_equal(eps, expected, decimal=10,
                                           err_msg="Normal strain should follow eps = -w/h")
    ...
    def test_shear_strain_calculation(self):
        ...
        np.testing.assert_array_almost_equal(gamma, expected, decimal=10,
...
class TestFieldQuantitiesEnergyReleaseRates(unittest.TestCase):
    ...
    def test_mode_I_energy_release_rate(self):
        ...
        np.testing.assert_array_almost_equal(G_I, expected, decimal=10,
    ...
    def test_mode_II_energy_release_rate(self):
        ...
        np.testing.assert_array_almost_equal(G_II, expected, decimal=10,
    ...
    def test_energy_release_rate_units(self):
        ...
        # Check unit conversions
        np.testing.assert_array_almost_equal(G_I_J, G_I_kJ * 1000, decimal=8,
                                           err_msg="J/m² should be 1000 times kJ/m²")
        np.testing.assert_array_almost_equal(G_I_N, G_I_kJ, decimal=10,
                                           err_msg="N/mm should equal kJ/m²")
...
class TestFieldQuantitiesPhysicalConsistency(unittest.TestCase):
    ...
    def test_displacement_continuity(self):
        ...
        self.assertAlmostEqual(u1[0], u2[0], places=6,
                              msg="Displacement should be continuous")
    ...
    def test_stress_sign_conventions(self):
        ...
        self.assertLess(sig_pos[0], 0, "Positive deflection should give compressive stress")

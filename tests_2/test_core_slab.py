...
class TestSlabBasicOperations(unittest.TestCase):
    ...
    def test_single_layer_slab(self):
        ...
        self.assertEqual(slab.H, 100.0, "Total thickness should equal single layer thickness")
...
class TestSlabCenterOfGravity(unittest.TestCase):
    ...
    def test_uniform_density_slab(self):
        ...
        self.assertAlmostEqual(slab.z_cog, 0.0, places=5,
...
class TestSlabVerticalCenterOfGravity(unittest.TestCase):
    ...
    def test_vertical_cog_inclined_surface(self):
        ...
        self.assertNotEqual(x_cog, 0.0, "Horizontal CoG should be non-zero for inclined surface")
        self.assertNotEqual(z_cog, 0.0, "Vertical CoG should be non-zero for inclined surface")
    ...
    def test_vertical_cog_steep_inclination(self):
        ...
        self.assertGreater(abs(x_cog_60), abs(x_cog_30),
                          "Steeper inclination should increase horizontal displacement")
        self.assertGreater(w_60, w_30,
...
class TestSlabElasticProperties(unittest.TestCase):
    ...
    def test_automatic_property_calculation(self):
        ...
        self.assertGreater(slab.Ei[0], 0, "Young's modulus should be auto-calculated and positive")
        self.assertGreater(slab.Gi[0], 0, "Shear modulus should be auto-calculated and positive")
...
class TestSlabPhysicalConsistency(unittest.TestCase):
    ...
    def test_center_of_gravity_bounds(self):
        ...
        layers = [
            Layer(rho=100, h=50),   # Very light top
            Layer(rho=500, h=50),   # Very heavy bottom
        ]
        slab = Slab(layers)
        
        # CoG should be within slab thickness bounds
        self.assertGreaterEqual(slab.z_cog, -slab.H/2,
                               "CoG should be within slab (above top)")
        self.assertLessEqual(slab.z_cog, slab.H/2,
                            "CoG should be within slab (below bottom)")

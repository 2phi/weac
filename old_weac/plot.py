...
import old_weac
from old_weac.tools import isnotebook
...
def stresses(instance: old_weac.Layered, x, z, i="", **segments):
    """Wrap stress plot."""
    data = [
...
def stress_criteria(instance: old_weac.Layered, x, stress, **segments):
...
def err_comp(instance: old_weac.Layered, da, Gdif, Ginc, mode=0):
...
def err_modes(instance: old_weac.Layered, da, G, kind="inc"):
    """Wrap energy release rate plot."""
...
def fea_disp(instance: old_weac.Layered, x, z, fea):
...
def fea_stress(instance: old_weac.Layered, xb, zb, fea):
    """Wrap stress plot."""
    data = [
...
def stress_envelope(instance: old_weac.Layered, x, z, **segments):
    """Wrap plot of stress and energy criteria."""
    sigma_c = 6.16
    tau_c = 5.09
    fn = 2
...
# def energy_release_ratecriterion_boundary(instance: old_weac.Layered, x, z, **segments):
#     """Wrap plot of stress and energy criteria."""
#     G1c = 0.56
#     G2c = 0.79
#     gn = 5.0

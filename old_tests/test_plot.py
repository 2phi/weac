...
class TestPlot(unittest.TestCase):
    ...
    def test_slab_profile(self):
        ...
        old_weac.plot.slab_profile(self.layered)
    ...
    def test_deformed(self):
        ...
        old_weac.plot.deformed(
            self.layered, xsl=self.xsl, xwl=self.xwl, z=self.z, phi=0
        )

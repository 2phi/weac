...
class Eigensystem:
    ...
    def calc_span_length(self):
        ...
        pn = self.get_surface_load(phi)[0]
        q0 = qn + pn
    ...
    def calc_rot_spring(self, collapse=False):
        """
        ...
        ---------
        collapse : boolean
            Determines whether weak-layer has collapsed. Default is False.
        ...
        if collapse:
            ...
            ratio = 1
        # Abbreviation term
        beta = (ratio*self.kn/(4*self.D11))**(1/4)

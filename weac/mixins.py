...
class FieldQuantitiesMixin:
    ...
    def u_weak_layer(self, Z, z0, y0=0, unit="mm"):
        """
    ...
    def v_weak_layer(self, Z, z0, y0=0, unit="mm"):
        """
    ...
    def w_weak_layer(self, Z, z0, y0=0, unit="mm"):
        """
        ...
        b = self.b
        return convert[unit] * (
            self.w(Z, h / 2, y0) * (1 - (z0 - h / 2) / t)
            + np.cos(Pi * (2 * z0 - h - t) / (2 * t))
            * (self.theta_wc(Z) + (2 * y0 / b) * self.theta_wl(Z))
        )

...
- Analysis package flatten: Steady State and CoupledCriterion and Envelopes live in independent files
- Split `Layer` and `WeakLayer` component models
- Jamieson–Johnson slab tensile strength method (`tensile_strength_method="jamieson_johnson"`)
- Schottner FC&DH weak-layer Young's modulus law (`E_method="schottner_fc_dh"`)

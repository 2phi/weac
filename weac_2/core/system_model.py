    ...
    **Example Usage:**
    ...
    def slab_touchdown(self) -> Optional[SlabTouchdown]:
        if self.config.touchdown:
            ...
            slab_touchdown = SlabTouchdown(scenario=self.scenario, eigensystem=self.eigensystem)
            ...
            if self.scenario.system_type == "pst-":
                ...
                logger.warning(f"Touchdown scenario redefinition not implemented for system_type: {self.scenario.system_type}")
    ...
    def unknown_constants(self) -> np.ndarray:
        ...
        if self.slab_touchdown is not None:
            ...
            return UnknownConstantsSolver.solve_for_unknown_constants(
                ...
                touchdown_l=self.slab_touchdown.touchdown_l, 

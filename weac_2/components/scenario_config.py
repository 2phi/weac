...
class ScenarioConfig(BaseModel):
    ...
    crack_length : float | None, optional
    ...
    """
    phi: float = Field(default=0, description="Slope angle in degrees, counterclockwise positive")
    touchdown: bool = Field(default=False, description="Whether to calculate the touchdown")
    # TODO: add more descriptive/human-readable system names
    system: Literal['skier', 'skiers', 'pst-', 'pst+', 'rot', 'trans', 'vpst-', '-vpst'] = Field(default='skiers', description="Type of system, '-pst', '+pst', ....")
    crack_length: float | None = Field(default=None, ge=0, description="Initial crack length [mm]")
